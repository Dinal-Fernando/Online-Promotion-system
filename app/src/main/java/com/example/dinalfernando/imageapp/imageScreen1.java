...
public class imageScreen1 extends AppCompatActivity implements BaseSliderView.OnSliderClickListener,ViewPagerEx.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_screen1);

        macid = new getmacid(imageScreen1.this).generateID();
        ...
        spinneritem.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (clickedItemName.equals("Main Screen")) {
                    startActivity(new Intent(imageScreen1.this, Main2Activity.class));
                }
                if (clickedItemName.equals("Image Screen 2")) {
                    startActivity(new Intent(imageScreen1.this, imageScreen2.class));
                }
                if (clickedItemName.equals("Video Screen")) {
                    startActivity(new Intent(imageScreen1.this, videoScreen.class));
                }
        ...
        for (String name : HashMapForURL.keySet()) {
            ...
            TextSliderView textSliderView = new TextSliderView(imageScreen1.this);
        ...
        sliderLayout.addOnPageChangeListener(imageScreen1.this);
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (wifistateextra == WifiManager.WIFI_STATE_ENABLED && counttime != 0) {
                ...
                Toast.makeText(imageScreen1.this, "Wifi is Enabled", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(imageScreen1.this, "Wifi is Disabled", Toast.LENGTH_SHORT).show();
                counttime++;
            }
    ...
    private Runnable mToastRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (imagesize == imagearray + 1) {
                Toast.makeText(imageScreen1.this, "Updating", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(imageScreen1.this, updating.class));
                imagearray++;
            }
    ...
    private Runnable mToast = new Runnable() {
        @Override
        public void run() {
            Toast.makeText(imageScreen1.this, "Wifi run", Toast.LENGTH_SHORT).show();
            wifichecker();
        }
    };
    ...
    private void wifichecker() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_REGIST, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(imageScreen1.this, "Register  Error", Toast.LENGTH_SHORT).show();
